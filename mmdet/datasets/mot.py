...
class MotDataset(CocoDataset):
    ...
    def calc_reid_sysu_topk(self, pred_feats, query_feats, test_img_list, query_img_list, query_boxlists, pred_boxlists,
                            gt_boxlists, topk,
    ...
    def eval_reid_sysu(self, pred_feats, query_feats, test_img_list, query_img_list, query_boxlists, pred_boxlists,
        ...
        prec, rec = self.calc_detection_sysu_prec_rec(pred_boxlists=pred_boxlists, gt_boxlists=gt_boxlists,
        ...
        topk = [1, 3, 5, 10]
        # CMC = []
        real_result, ideal_result = self.calc_reid_sysu_topk(pred_feats, query_feats, test_img_list, query_img_list,
                                                             query_boxlists, pred_boxlists,
